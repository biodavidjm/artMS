...
mq2mss_PTM = function(ptmsites_file){
  ...
  x.long = melt(x[,c(grep('^Phospho\\.\\.STY\\.\\.Probabilities$|Intensity\\.[A-Za-z0-9]+__|^id$|^Charge$', names(x)))], 
                id=c('Phospho..STY..Probabilities','id','Charge'), 
  ...
  mss = x.long[,c('ProteinName','PeptideSequence','PrecursorCharge','FragmentIon','ProductCharge','IsotopeLabelType','Condition','BioReplicate','Run','Intensity')]
